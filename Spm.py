...
os.system("clear")
autoketik(f"{biru}[{kuning}Warning{biru}] {W}Menyala Abangkuh")
time.sleep(3)
os.system("xdg-open https://www.instagram.com/rafli.agt/")
autoketik(f"{biru}[{kuning}Warning{biru}] {W}WEBSITE : WWW.MAMAH-CHEAT.MY.ID")
time.sleep(3)
os.system("clear")
autoketik(f"""
{abu}-----------------------------------------
{putih}[{biru}•{putih}] {biru}Author {putih}   : Muhammad Rafli
{putih}[{biru}•{putih}] {abu}GitHub {putih}   : Rafli Coy
{putih}[{biru}•{putih}] {merah}You{putih}Tube {putih}  : By Rafli
{putih}[{biru}•{putih}] {ungu}Instagram {putih}: @rafli.agt
